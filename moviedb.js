(function (f) { if (typeof exports === 'object' && typeof module !== 'undefined') { module.exports = f() } else if (typeof define === 'function' && define.amd) { define([], f) } else { var g; if (typeof window !== 'undefined') { g = window } else if (typeof global !== 'undefined') { g = global } else if (typeof self !== 'undefined') { g = self } else { g = this }g.MDB = f() } })(function () {
 ...
 */
      ...
      var execMethod = function (type, params, endpoint, fn) {
        ...
        if (type === 'GET') { req.query(params) } else { req.send(params) }
